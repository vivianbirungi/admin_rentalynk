    ...
    <div className={styles.container}>
      <div className={styles.item}>
        ...
        <div className={styles.texts}>
          ...
          <div className={styles.bookingItem}><MdOutlineAutoAwesome size={24} color='green'/><span> Approved</span> <span>{approved}</span></div>
          <div className={styles.bookingItem}><MdOutlineHourglassEmpty size={24} color='#f7737375'/><span> Pending</span><span>{pending}</span></div>
          <div className={styles.bookingItem}><AiOutlineStop size={24} color='gray'/><span>Declined</span><span>{declined}</span></div>
          </div>
